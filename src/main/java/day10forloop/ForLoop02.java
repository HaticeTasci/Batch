    ...
    public static void main(String[] args) {
        ...
        for(int i=0; i<num.length(); i++){
            ...
            if(num.indexOf(ch)==num.lastIndexOf(ch)){
                ...
                //If you put "char"data type insode the "valuOf"method,it gives you the ASCII value of the char
                //if you use "non-digits "caharakter in "valueOf" method,it gives error.
